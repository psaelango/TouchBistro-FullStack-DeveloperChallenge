import PrimeAndMedians, { Output } from '../classes/PrimeAndMedians';
const primeMedians = new PrimeAndMedians();

export const medianOfPrimes = (val: number, sieveAlgo = false): Output => {
  return primeMedians.getResult(val, undefined, sieveAlgo);
};
